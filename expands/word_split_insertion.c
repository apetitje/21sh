...
/*   Updated: 2017/06/21 14:27:12 by apetitje         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
		...
		size_t *tab_size, size_t token_size)
{
	...
	*tab_size = 0;
	...
	{
		if (!((*tabl)[*tab_size].word = ft_strdup(to_copy[*tab_size].word)))
			exit_prog(EXIT_FAILURE, "Malloc error\n");
